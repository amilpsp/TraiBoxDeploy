<template>
<section id="component-container" class="flex flex-row flex-wrap gap-5 text-center">
  <div id="links" class="flex order-1 w-full justify-center gap-3 md:gap-10 flex-wrap">
