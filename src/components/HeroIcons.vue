<template>
  <div id="iconWrapper" class="flex flex-wrap justify-around items-baseline xl:justify-center xl:gap-8">
    <div class="icons text-center w-80 h-80  m-4 flex flex-col items-center justify-center">
      <div >
        <svg xmlns="http://www.w3.org/2000/svg" width="5rem" height="5rem" viewBox="3 2 19 19">
          <path
          fill="url(#gradient)"
          ...
          <defs>
            <linearGradient id="gradient" x1="0%" y1="0%" x2="100%" y2="100%">
              <stop offset="0%" style="stop-color:#36C5BC;" />
              <stop offset="100%" style="stop-color:#0024A6;" />
            </linearGradient>
          </defs>
        </svg>
      </div>
      <h3 class="pt-4 font-semibold text-zinc-200">AI Analytics</h3>
      <p class="pt-4">
        Adds-on enabling technology applications to improve your performance,
        integrating: AI - Machine Learning, IoT, Tokens and data analytics.
      </p>
    </div>
    <div class="hidden halfXl:block halfXl:border-r-2 halfXl:border-cyan-800 halfXl:h-60 halfXl:self-center"></div>
    <div class="icons text-center w-80 h-80 m-4 flex flex-col items-center justify-center">
      <div>
      ...
      <h3 class="pt-4 font-semibold text-zinc-200">Blockchain Payment</h3>
      <p class="pt-4">
        Govern every trade among consensual parties by permissioned blockchain
    ...
    <div class="icons text-center w-80 h-80 m-4 flex flex-col items-center justify-center">
      ...
      <h3 class="pt-4 font-semibold text-zinc-200">Sustainability Tracking</h3>
      <p class="pt-4">
        Track and manage every delivery milestone with automated notifications.
      </p>
    </div>
  </div>
</template>