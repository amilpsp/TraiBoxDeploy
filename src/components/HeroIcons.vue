<template>
  <div id="iconWrapper" class="flex flex-row flex-wrap items-baseline justify-center mt-4 gap-5 md:gap-20 ">
    <div class="icons text-center w-50  m-4 flex flex-col items-center justify-center ">
      ...
      <p class="font-semibold tracking-wide text-lg pt-4 text-blue-200">AI Analytics</p>
    ...
    <div class="icons text-center w-50 m-4 flex flex-col items-center justify-center">
      ...
      <p class="font-semibold tracking-wide text-lg pt-4 text-blue-200">Blockchain<br/> Payment</p>
    ...
    <div class="icons text-center w-50 m-4 flex flex-col items-center justify-center">
      ...
      <p class="font-semibold tracking-wide text-lg pt-4 text-blue-200">Sustainability <br/> Tracking</p>
