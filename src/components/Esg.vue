<template>
    ...
    <div class="flex flex-col gap-4 lg:flex-row items-stretch ">
        <article class="flex flex-col gap-4  bg-blue-800/20 px-6 py-4 w-full rounded-lg relative shadow-lg md:max-w-sm">
        ...
        <article class="flex flex-col gap-4  bg-blue-800/20 px-6 py-4 w-full rounded-lg relative shadow-lg md:max-w-sm">
            ...
            <ul class="flex flex-col list-disc pl-4 gap-1">
                <li>Boarder diversity and structure</li>
                <li>Executive compensation</li>
                <li>Transparency and accountability</li>
                <li>Corrution and bribery</li>
                <li>Sharehodler</li>
            </ul>
        </article>
    </div>
